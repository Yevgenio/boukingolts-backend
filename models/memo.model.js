...
const memoSchema = new mongoose.Schema({
  ...
  description: String,
  type: { type: String, enum: ['product', 'chat', 'external', 'blog'], required: true }, // Type of memo
  targetId: { type: String, default: null }, // Stores productId, chatId, or null for external/blog
